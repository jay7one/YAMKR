...
#    Mar 03, 2024 11:16:48 AM GMT  platform: Linux
...
class PyMouseMacros:
    def __init__(self, top=None):
        ...
        self.FrameMacroButtons = tk.Frame(self.top)
        self.FrameMacroButtons.place(relx=0.259, rely=0.014, relheight=0.069
                , relwidth=0.728)
        self.FrameMacroButtons.configure(relief='groove')
        self.FrameMacroButtons.configure(borderwidth="2")
        self.FrameMacroButtons.configure(relief="groove")

        self.BtnRecord = tk.Button(self.FrameMacroButtons)
        ...
        self.BtnClear = tk.Button(self.FrameMacroButtons)
        ...
        self.BtnRestore = tk.Button(self.FrameMacroButtons)
        ...
        self.BtnSave = tk.Button(self.FrameMacroButtons)
        ...
        self.BtnKPressIntv.configure(state='active')
