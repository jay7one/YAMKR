...
#    Mar 20, 2024 08:29:02 PM GMT  platform: Linux
...
class PyMouseMacro:
    def __init__(self, top=None):
        ...
        self.LFrameEvents.configure(takefocus="1")
        ...
        self.btn_delay_update = tk.Button(self.frame_macro_evt_buttons)
        self.btn_delay_update.place(relx=0.635, rely=0.204, height=31, width=61)
        self.btn_delay_update.configure(activebackground="#d9d9d9")
        self.btn_delay_update.configure(text='''Add''')
