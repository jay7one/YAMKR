...
#    Mar 09, 2024 09:49:22 PM GMT  platform: Linux
...
class PyMouseMacro:
    def __init__(self, top=None):
        ...
        self.menubar.add_cascade(compound='left'
                ,font="-family {DejaVu Sans} -size 12", label='Minimize'
                ,menu=self.sub_menu, )
        self.sub_menu.add_checkbutton(variable=self.checks_1
                ,command=PyMouseMacro_support.menu_min_record, compound='left'
                ,font="-family {DejaVu Sans} -size 12", label='On Record')
        self.sub_menu.add_checkbutton(variable=self.checks_2
        ...
        self.sub_menu1.add_command(compound='left'
                ,font="-family {DejaVu Sans} -size 12", label='Check for Update')
        ...
        self.btn_refresh.place(relx=0.656, rely=0.204, height=31, width=71)
        ...
        self.btn_refresh.configure(font="-family {DejaVu Sans} -size 10")
        self.btn_refresh.configure(text='''Refresh''')

        self.btn_folder = tk.Button(self.frame_macro_list_buttons)
        self.btn_folder.place(relx=0.347, rely=0.204, height=31, width=71)
        self.btn_folder.configure(activebackground="#d9d9d9")
        self.btn_folder.configure(command=PyMouseMacro_support.btn_cmd_folder)
        self.btn_folder.configure(font="-family {DejaVu Sans} -size 10")
        self.btn_folder.configure(text='''Folder''')
