...
#    Mar 20, 2024 08:29:09 PM GMT  platform: Linux
...
def btn_cmd_rename(*args):
    if _debug:
        print('PyMouseMacro_support.btn_cmd_rename')
        for arg in args:
            print ('    another arg:', arg)
        sys.stdout.flush()
...
def menu_autosave(*args):
    if _debug:
        print('PyMouseMacro_support.menu_autosave')
        for arg in args:
            print ('    another arg:', arg)
        sys.stdout.flush()
